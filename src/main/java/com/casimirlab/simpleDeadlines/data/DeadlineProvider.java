...
public class DeadlineProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (Matcher.match(uri)) {
            case COUNT:
                ...
                break;
            case DEADLINES:
                ret = queryDeadlines(false, sortOrder);
                break;
            case DEADLINES_ARCHIVED:
                ret = queryDeadlines(true, sortOrder);
                break;
            case DEADLINES_GROUPS:
            ...
            case DEADLINES_ARCHIVED_GROUPS:
                ...
                break;
            case DEADLINES_GROUP_LABEL:
                ret = queryDeadlines(false, uri.getLastPathSegment(), sortOrder);
                break;
            case DEADLINES_ARCHIVED_GROUP_LABEL:
                ret = queryDeadlines(true, uri.getLastPathSegment(), sortOrder);
                break;
            case DEADLINE_ID:
    ...
    private Cursor queryDeadlines(boolean archived, String sortOrder) {
        return queryDeadlines(archived, null, sortOrder);
    }

    private Cursor queryDeadlines(boolean archived, String group, String sortOrder) {
