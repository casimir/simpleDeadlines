...
{
  private static final long DAY_LEN = 1000 * 60 * 60 * 24;
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
    ...
    Date today = new Date();
    today.setHours(0);
    long days = model.DueDate().getTime() / DAY_LEN - today.getTime() / DAY_LEN;
